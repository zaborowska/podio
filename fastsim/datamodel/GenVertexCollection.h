...
//  GenVertexCollection(GenVertexVector* data, int collectionID);
  ...
  const std::array<LorentzVectorPosition,arraysize> Position() const;
...
private:
  ...
  std::vector<ConstMCParticle>* m_rel_Daughters; //relation buffer for r/w
  std::vector<std::vector<ConstMCParticle>*> m_rel_Daughters_tmp;
   std::vector<ConstMCParticle>* m_rel_Parents; //relation buffer for r/w
  std::vector<std::vector<ConstMCParticle>*> m_rel_Parents_tmp;
...
template<size_t arraysize>
const std::array<LorentzVectorPosition,arraysize> GenVertexCollection::Position() const {
  std::array<LorentzVectorPosition,arraysize> tmp;
