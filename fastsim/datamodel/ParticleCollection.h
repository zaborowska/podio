...
private:
  ...
  std::vector<ConstMCParticle>* m_rel_SimParticle; //relation buffer for r/w
...
template<size_t arraysize>
const std::array<BareParticle,arraysize> ParticleCollection::Core() const {
  std::array<BareParticle,arraysize> tmp;
